...
export default function SendRemindersModal({ onClose }) {
  ...
  return (
    <>
      ...
      <div className="responsive-modal-panel" style={{ position: "fixed", top: "50%", left: "50%", zIndex: 60, transform: "translate(-50%,-50%)", width: "100%", maxWidth: 500, background: "var(--surface)", border: "1px solid var(--border2)", borderRadius: 16, boxShadow: "0 24px 60px rgba(0,0,0,0.5)", display: "flex", flexDirection: "column", maxHeight: "85vh", animation: "modalIn .18s ease" }}>
